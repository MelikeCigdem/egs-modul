...
function NodeInfo({ node }) {
    ...
    return (
        <Box sx={{ mb: 2 }}>
            ...
            <br />
            <Typography variant="caption">
                <strong>Oluşturulma:</strong>deneme
            </Typography>
            <br />
            <Typography variant="caption">
                <strong>Oluşturan:</strong> {"deneme" || "-"}
            </Typography>
            <br />
            <Typography variant="caption">
                <strong>Değiştirilme:</strong> deneme
            </Typography>
            <br />
            <Typography variant="caption">
                <strong>Değiştiren:</strong> {deneme || "-"}
            </Typography>
        </Box>
    );
}
...
export default function CinegyArchive() {
    ...
    return (
        <Card>
            <CardHeader
                title="Cinegy Arşiv"
                subheader={<NodeInfo node={selectedNode} />}
            />
            <CardContent>
